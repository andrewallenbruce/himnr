...
$[($ **Work RVU** $\times$ **Work GPCI** $) + ($ *Facility* **PE RVU** $\times$ **PE GPCI** $) + ($ **MP RVU** $\times$ **MP GPCI** $)]$ $\times$ **CF**

## Non-Facility

$[($ **Work RVU** $\times$ **Work GPCI** $) + ($ *Non-Facility* **PE RVU** $\times$ **PE GPCI** $) + ($ **MP RVU** $\times$ **MP GPCI** $)]$ $\times$ **CF**
:::
